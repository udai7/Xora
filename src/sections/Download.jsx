...
const Download = () => {
  return (
  <section>
    <Element name="download" className="g7 relative pt-24 pb-32 max-md:py-16">
        <div className="container">
            <div className="flex items-center">
                <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex256 max-md:flex-100">
                    ...
                    <p className="body-1 mb-10 max-w-md"> 
                        Try it now on IOS, Android, PC, Web - whatever your flavour, we've got you covered
                    </p>
                    <ul className="flex flex-wrap items-center gap-6">
                        {links.map(({id, url, icon}) => (
                            <li key={id} className="download_tech-link 
                            download_tech-link_last-before download_tech-link_last-after">
                                <a href={url} className="size-22 download_tech-icon_before
                                relative flex items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500">
            ...
            <ul className="mt-24 flex justify-center max-lg:hidden">
                {logos.map(({id, width, url, height, title}) => (
